...
1-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/1.scm"
...
8-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/8.scm"
...
13-foment:
	...
	foment -X .sld -I . srfi-test/r7rs-programs/13.scm
...
13-foment-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -X .sld -I . srfi-test/r7rs-programs/13.scm"
...
13-gambit-compiler-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && ls srfi/13.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -o ./test -exe -nopreload ./ srfi-test/r7rs-programs/13.scm && ./test"
...
13-gambit-interpreter-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsi -:search=./ srfi-test/r7rs-programs/13.scm"
...
13-kawa:
	...
	kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/13.scm
...
13-kawa-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/kawa:latest bash -c "cd workdir && kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/13.scm"
...
13-stklos:
	...
	stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/13.scm
...
13-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/13.scm"
...
14-foment:
	...
	foment -X .sld -I . srfi-test/r7rs-programs/14.scm
...
14-foment-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -X .sld -I . srfi-test/r7rs-programs/14.scm"
...
14-gambit-compiler-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && ls srfi/14.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -o ./test -exe -nopreload ./ srfi-test/r7rs-programs/14.scm && ./test"
...
14-gambit-interpreter-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsi -:search=./ srfi-test/r7rs-programs/14.scm"
...
14-kawa:
	...
	kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/14.scm
...
14-kawa-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/kawa:latest bash -c "cd workdir && kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/14.scm"
...
14-stklos:
	...
	stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/14.scm
...
14-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/14.scm"
...
26-foment:
	...
	foment -X .sld -I . srfi-test/r7rs-programs/26.scm
...
26-foment-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -X .sld -I . srfi-test/r7rs-programs/26.scm"
...
26-gambit-compiler-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && ls srfi/26.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -o ./test -exe -nopreload ./ srfi-test/r7rs-programs/26.scm && ./test"
...
26-gambit-interpreter-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsi -:search=./ srfi-test/r7rs-programs/26.scm"
...
26-kawa:
	...
	kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/26.scm
...
26-kawa-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/kawa:latest bash -c "cd workdir && kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/26.scm"
...
26-stklos:
	...
	stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/26.scm
...
26-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/26.scm"
...
28-foment:
	...
	foment -X .sld -I . srfi-test/r7rs-programs/28.scm
...
28-foment-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -X .sld -I . srfi-test/r7rs-programs/28.scm"
...
28-gambit-compiler-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && ls srfi/28.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -o ./test -exe -nopreload ./ srfi-test/r7rs-programs/28.scm && ./test"
...
28-gambit-interpreter-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsi -:search=./ srfi-test/r7rs-programs/28.scm"
...
28-kawa:
	...
	kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/28.scm
...
28-kawa-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/kawa:latest bash -c "cd workdir && kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/28.scm"
...
28-stklos:
	...
	stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/28.scm
...
28-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/28.scm"
...
38-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/38.scm"
...
39-mit-scheme:
	...
	mit-scheme --batch-mode --load ./srfi/8.sld ./srfi/1.sld ./srfi/38.sld ./srfi/48.sld ./srfi/64.sld srfi-test/r7rs-programs/39.scm
...
39-mit-scheme-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/mit-scheme:latest bash -c "cd workdir && mit-scheme --batch-mode --load ./srfi/8.sld ./srfi/1.sld ./srfi/38.sld ./srfi/48.sld ./srfi/64.sld srfi-test/r7rs-programs/39.scm"
...
39-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/39.scm"
...
48-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/48.scm"
...
60-foment:
	...
	foment -X .sld -I . srfi-test/r7rs-programs/60.scm
...
60-foment-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -X .sld -I . srfi-test/r7rs-programs/60.scm"
...
60-gambit-compiler-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && ls srfi/60.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -o ./test -exe -nopreload ./ srfi-test/r7rs-programs/60.scm && ./test"
...
60-gambit-interpreter-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsi -:search=./ srfi-test/r7rs-programs/60.scm"
...
60-kawa:
	...
	kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/60.scm
...
60-kawa-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/kawa:latest bash -c "cd workdir && kawa --r7rs --full-tailcalls -Dkawa.import.path=../../*.sld:*.sld srfi-test/r7rs-programs/60.scm"
...
60-stklos:
	...
	stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/60.scm
...
60-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/60.scm"
...
64-stklos-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:latest bash -c "cd workdir && stklos --debug -I . -I ./srfi -f srfi-test/r7rs-programs/64.scm"
