...
test-srfi-8-foment-docker-head:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/8.scm"
...
test-srfi-1-foment-docker-head:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/1.scm"
...
test-srfi-14-foment-docker-head:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/14.scm"
...
test-srfi-26-foment-docker-head:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/26.scm"
...
test-srfi-28-foment:
	...
	foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/28.scm
...
test-srfi-28-foment-docker-head:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/28.scm"
...
test-srfi-13-foment:
	...
	foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/13.scm
...
test-srfi-13-foment-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:latest bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/13.scm"
...
test-srfi-13-foment-docker-head:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/13.scm"
...
srfi-60-chibi-build-library-docker:
	

test-srfi-60-chibi-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/chibi:head bash -c "cd workdir && chibi-scheme -I . srfi-test/r7rs-programs/60.scm"

srfi-60-chibi-build-library-docker-head:
	

test-srfi-60-chicken:
	  cp srfi/60.sld srfi-60.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-60.sld 
...
srfi-60-chicken-build-library:
	  cp srfi/60.sld srfi-60.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-60.sld 

test-srfi-60-chicken-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/60.sld srfi-60.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-60.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir && csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60"

srfi-60-chicken-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/60.sld srfi-60.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-60.sld" 

test-srfi-60-chicken-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/60.sld srfi-60.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-60.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir && csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60"

srfi-60-chicken-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/60.sld srfi-60.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-60.sld" 

test-srfi-60-cyclone:
	 cyclone -I . srfi/60.sld 
	cyclone -I . srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60

srfi-60-cyclone-build-library:
	 cyclone -I . srfi/60.sld 

test-srfi-60-cyclone-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/60.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60"

srfi-60-cyclone-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/60.sld" 

test-srfi-60-cyclone-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/60.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60"

srfi-60-cyclone-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/60.sld" 

test-srfi-60-foment:
	
	foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/60.scm

srfi-60-foment-build-library:
	

test-srfi-60-foment-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/foment:latest bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/60.scm"

srfi-60-foment-build-library-docker:
	

test-srfi-60-foment-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/60.scm"

srfi-60-foment-build-library-docker-head:
	

test-srfi-60-gambit:
	 gsc -:search=. srfi/60 
	gsc -exe ./ -nopreload srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 -:search=. && rm srfi-test/r7rs-programs/60

srfi-60-gambit-build-library:
	 gsc -:search=. srfi/60 

test-srfi-60-gambit-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/60"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -exe ./ -nopreload srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 -:search=. && rm srfi-test/r7rs-programs/60"

srfi-60-gambit-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/60" 

test-srfi-60-gambit-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/60"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -exe ./ -nopreload srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 -:search=. && rm srfi-test/r7rs-programs/60"

srfi-60-gambit-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/60" 
...
srfi-60-gauche-build-library-docker:
	

test-srfi-60-gauche-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/gauche:head bash -c "cd workdir && gosh -r7 -I . srfi-test/r7rs-programs/60.scm"

srfi-60-gauche-build-library-docker-head:
	

test-srfi-60-gerbil:
	 gxc -O srfi/60.sld 
	gxi --lang r7rs srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60

srfi-60-gerbil-build-library:
	 gxc -O srfi/60.sld 

test-srfi-60-gerbil-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/60.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxi --lang r7rs srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60"

srfi-60-gerbil-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/60.sld" 

test-srfi-60-gerbil-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/60.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxi --lang r7rs srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60"

srfi-60-gerbil-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/60.sld" 
...
srfi-60-guile-build-library-docker:
	

test-srfi-60-guile-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/guile:head bash -c "cd workdir && guile --fresh-auto-compile --r7rs -L . srfi-test/r7rs-programs/60.scm"

srfi-60-guile-build-library-docker-head:
	

test-srfi-60-kawa:
	
	kawa --r7rs -Dkawa.import.path=../.. srfi-test/r7rs-programs/60.scm

srfi-60-kawa-build-library:
	

test-srfi-60-kawa-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/kawa:latest bash -c "cd workdir && kawa --r7rs -Dkawa.import.path=../.. srfi-test/r7rs-programs/60.scm"

srfi-60-kawa-build-library-docker:
	

test-srfi-60-kawa-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/kawa:head bash -c "cd workdir && kawa --r7rs -Dkawa.import.path=../.. srfi-test/r7rs-programs/60.scm"

srfi-60-kawa-build-library-docker-head:
	

test-srfi-60-larceny:
	
	larceny -r7 -I . srfi-test/r7rs-programs/60.scm

srfi-60-larceny-build-library:
	

test-srfi-60-larceny-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/larceny:latest bash -c "cd workdir && larceny -r7 -I . srfi-test/r7rs-programs/60.scm"

srfi-60-larceny-build-library-docker:
	

test-srfi-60-larceny-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/larceny:head bash -c "cd workdir && larceny -r7 -I . srfi-test/r7rs-programs/60.scm"

srfi-60-larceny-build-library-docker-head:
...
srfi-60-loko-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && ls srfi/60.sld" 

test-srfi-60-loko-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/60.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && loko -std=r7rs --compile srfi-test/r7rs-programs/60.scm && srfi-test/r7rs-programs/60 && rm srfi-test/r7rs-programs/60"

srfi-60-loko-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/60.sld" 
...
srfi-60-mit-scheme-build-library:
...
srfi-60-mit-scheme-build-library-docker:
	

test-srfi-60-mit-scheme-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mit-scheme:head bash -c "cd workdir && mit-scheme --batch-mode --load ./srfi/26.sld ./srfi/28.sld ./srfi/64.sld srfi-test/r7rs-programs/60.scm"

srfi-60-mit-scheme-build-library-docker-head:
...
srfi-60-mosh-build-library-docker:
	

test-srfi-60-mosh-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mosh:head bash -c "cd workdir && mosh --loadpath=. srfi-test/r7rs-programs/60.scm"

srfi-60-mosh-build-library-docker-head:
...
srfi-60-racket-build-library-docker:
	

test-srfi-60-racket-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/racket:head bash -c "cd workdir && racket -I r7rs -S . --script srfi-test/r7rs-programs/60.scm"

srfi-60-racket-build-library-docker-head:
...
srfi-60-sagittarius-build-library:
...
srfi-60-sagittarius-build-library-docker:
	

test-srfi-60-sagittarius-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius:head bash -c "cd workdir && sash -r7 -L . -L ./srfi srfi-test/r7rs-programs/60.scm"

srfi-60-sagittarius-build-library-docker-head:
...
srfi-60-stklos-build-library-docker:
	

test-srfi-60-stklos-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/stklos:head bash -c "cd workdir && stklos -I . -I ./srfi -f srfi-test/r7rs-programs/60.scm"

srfi-60-stklos-build-library-docker-head:
...
srfi-60-skint-build-library-docker:
	

test-srfi-60-skint-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/skint:head bash -c "cd workdir && skint -I ./ srfi-test/r7rs-programs/60.scm"

srfi-60-skint-build-library-docker-head:
...
srfi-60-tr7-build-library-docker:
	

test-srfi-60-tr7-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/tr7:head bash -c "cd workdir && tr7i srfi-test/r7rs-programs/60.scm"

srfi-60-tr7-build-library-docker-head:
...
srfi-60-ypsilon-build-library-docker:
	

test-srfi-60-ypsilon-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/ypsilon:head bash -c "cd workdir && ypsilon --r7rs --loadpath=. --loadpath=./srfi srfi-test/r7rs-programs/60.scm"

srfi-60-ypsilon-build-library-docker-head:
...
test-srfi-64-foment:
	...
	foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/64.scm
...
test-srfi-64-foment-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:latest bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/64.scm"
...
test-srfi-64-foment-docker-head:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/64.scm"
...
test-srfi-151-foment:
	...
	foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/151.scm
...
test-srfi-151-foment-docker:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:latest bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/151.scm"
...
test-srfi-151-foment-docker-head:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I ./ -I ./srfi -l srfi-test/r7rs-programs/151.scm"
