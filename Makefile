...
test-srfi-8-chicken-build-library:
	 cp srfi/8.sld srfi-8.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-8.sld
...
test-srfi-8-chicken-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/8.sld srfi-8.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-8.sld"
...
test-srfi-8-chicken-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/8.sld srfi-8.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-8.sld"
...
test-srfi-8-cyclone-build-library:
	cyclone -I . srfi/8.sld
...
test-srfi-8-cyclone-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/8.sld"
...
test-srfi-8-cyclone-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/8.sld"
...
test-srfi-8-gambit-build-library:
	gsc -:search=. srfi/8
...
test-srfi-8-gambit-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/8"
...
test-srfi-8-gambit-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/8"
...
test-srfi-8-gerbil-build-library:
	gxc -O srfi/8.sld
...
test-srfi-8-gerbil-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/8.sld"
...
test-srfi-8-gerbil-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/8.sld"
...
test-srfi-8-loko-build-library:
	ls srfi/8.sld
...
test-srfi-8-loko-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && ls srfi/8.sld"
...
test-srfi-8-loko-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/8.sld"
...
test-srfi-1-chicken-build-library:
	 cp srfi/1.sld srfi-1.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-1.sld
...
test-srfi-1-chicken-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/1.sld srfi-1.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-1.sld"
...
test-srfi-1-chicken-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/1.sld srfi-1.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-1.sld"
...
test-srfi-1-cyclone-build-library:
	cyclone -I . srfi/1.sld
...
test-srfi-1-cyclone-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/1.sld"
...
test-srfi-1-cyclone-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/1.sld"
...
test-srfi-1-gambit-build-library:
	gsc -:search=. srfi/1
...
test-srfi-1-gambit-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/1"
...
test-srfi-1-gambit-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/1"
...
test-srfi-1-gerbil-build-library:
	gxc -O srfi/1.sld
...
test-srfi-1-gerbil-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/1.sld"
...
test-srfi-1-gerbil-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/1.sld"
...
test-srfi-1-loko-build-library:
	ls srfi/1.sld
...
test-srfi-1-loko-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && ls srfi/1.sld"
...
test-srfi-1-loko-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/1.sld"
...
test-srfi-26-chicken-build-library:
	 cp srfi/26.sld srfi-26.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-26.sld
...
test-srfi-26-chicken-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/26.sld srfi-26.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-26.sld"
...
test-srfi-26-chicken-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/26.sld srfi-26.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-26.sld"
...
test-srfi-26-cyclone-build-library:
	cyclone -I . srfi/26.sld
...
test-srfi-26-cyclone-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/26.sld"
...
test-srfi-26-cyclone-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/26.sld"
...
test-srfi-26-gambit-build-library:
	gsc -:search=. srfi/26
...
test-srfi-26-gambit-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/26"
...
test-srfi-26-gambit-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/26"
...
test-srfi-26-gerbil-build-library:
	gxc -O srfi/26.sld
...
test-srfi-26-gerbil-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/26.sld"
...
test-srfi-26-gerbil-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/26.sld"
...
test-srfi-26-loko-build-library:
	ls srfi/26.sld
...
test-srfi-26-loko-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && ls srfi/26.sld"
...
test-srfi-26-loko-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/26.sld"
...
test-srfi-28-chicken-build-library:
	 cp srfi/28.sld srfi-28.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-28.sld
...
test-srfi-28-chicken-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/28.sld srfi-28.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-28.sld"
...
test-srfi-28-chicken-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/28.sld srfi-28.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-28.sld"
...
test-srfi-28-cyclone-build-library:
	cyclone -I . srfi/28.sld
...
test-srfi-28-cyclone-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/28.sld"
...
test-srfi-28-cyclone-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/28.sld"
...
test-srfi-28-gambit-build-library:
	gsc -:search=. srfi/28
...
test-srfi-28-gambit-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/28"
...
test-srfi-28-gambit-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/28"
...
test-srfi-28-gerbil-build-library:
	gxc -O srfi/28.sld
...
test-srfi-28-gerbil-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/28.sld"
...
test-srfi-28-gerbil-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/28.sld"
...
test-srfi-28-loko-build-library:
	ls srfi/28.sld
...
test-srfi-28-loko-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && ls srfi/28.sld"
...
test-srfi-28-loko-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/28.sld"
...
test-srfi-64-chicken-build-library:
	 cp srfi/64.sld srfi-64.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-64.sld
...
test-srfi-64-chicken-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/64.sld srfi-64.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-64.sld"
...
test-srfi-64-chicken-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/64.sld srfi-64.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-64.sld"
...
test-srfi-64-cyclone-build-library:
	cyclone -I . srfi/64.sld
...
test-srfi-64-cyclone-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/64.sld"
...
test-srfi-64-cyclone-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/64.sld"
...
test-srfi-64-gambit-build-library:
	gsc -:search=. srfi/64
...
test-srfi-64-gambit-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/64"
...
test-srfi-64-gambit-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/64"
...
test-srfi-64-gerbil-build-library:
	gxc -O srfi/64.sld
...
test-srfi-64-gerbil-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/64.sld"
...
test-srfi-64-gerbil-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/64.sld"
...
test-srfi-64-loko-build-library:
	ls srfi/64.sld
...
test-srfi-64-loko-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && ls srfi/64.sld"
...
test-srfi-64-loko-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/64.sld"
...
test-srfi-71-chibi:
	...
	chibi-scheme -I . srfi-test/r7rs-programs/71.scm


test-srfi-71-chibi-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/chibi:latest bash -c "cd workdir && chibi-scheme -I . srfi-test/r7rs-programs/71.scm"


test-srfi-71-chibi-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/chibi:head bash -c "cd workdir && chibi-scheme -I . srfi-test/r7rs-programs/71.scm"


test-srfi-71-chicken:
	  cp srfi/71.sld srfi-71.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-71.sld 
	csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71

test-srfi-71-chicken-build-library:
	 cp srfi/71.sld srfi-71.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-71.sld

test-srfi-71-chicken-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/71.sld srfi-71.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-71.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir && csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71"

test-srfi-71-chicken-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:latest bash -c "cd workdir &&  cp srfi/71.sld srfi-71.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-71.sld"

test-srfi-71-chicken-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/71.sld srfi-71.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-71.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir && csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71"

test-srfi-71-chicken-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken:head bash -c "cd workdir &&  cp srfi/71.sld srfi-71.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-71.sld"

test-srfi-71-cyclone:
	 cyclone -I . srfi/71.sld 
	cyclone -I . srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71

test-srfi-71-cyclone-build-library:
	cyclone -I . srfi/71.sld

test-srfi-71-cyclone-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/71.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71"

test-srfi-71-cyclone-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:latest bash -c "cd workdir && cyclone -I . srfi/71.sld"

test-srfi-71-cyclone-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/71.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71"

test-srfi-71-cyclone-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone:head bash -c "cd workdir && cyclone -I . srfi/71.sld"

test-srfi-71-foment:
	
	foment -I --load srfi-test/r7rs-programs/71.scm


test-srfi-71-foment-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/foment:latest bash -c "cd workdir && foment -I --load srfi-test/r7rs-programs/71.scm"


test-srfi-71-foment-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/foment:head bash -c "cd workdir && foment -I --load srfi-test/r7rs-programs/71.scm"


test-srfi-71-gambit:
	 gsc -:search=. srfi/71 
	gsc -exe ./ -nopreload srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 -:search=. && rm srfi-test/r7rs-programs/71

test-srfi-71-gambit-build-library:
	gsc -:search=. srfi/71

test-srfi-71-gambit-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/71"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -exe ./ -nopreload srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 -:search=. && rm srfi-test/r7rs-programs/71"

test-srfi-71-gambit-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:latest bash -c "cd workdir && gsc -:search=. srfi/71"

test-srfi-71-gambit-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/71"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -exe ./ -nopreload srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 -:search=. && rm srfi-test/r7rs-programs/71"

test-srfi-71-gambit-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit:head bash -c "cd workdir && gsc -:search=. srfi/71"

test-srfi-71-gauche:
	
	gosh -r7 -I . srfi-test/r7rs-programs/71.scm


test-srfi-71-gauche-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/gauche:latest bash -c "cd workdir && gosh -r7 -I . srfi-test/r7rs-programs/71.scm"


test-srfi-71-gauche-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/gauche:head bash -c "cd workdir && gosh -r7 -I . srfi-test/r7rs-programs/71.scm"


test-srfi-71-gerbil:
	 gxc -O srfi/71.sld 
	gxi --lang r7rs srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71

test-srfi-71-gerbil-build-library:
	gxc -O srfi/71.sld

test-srfi-71-gerbil-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/71.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxi --lang r7rs srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71"

test-srfi-71-gerbil-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:latest bash -c "cd workdir && gxc -O srfi/71.sld"

test-srfi-71-gerbil-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/71.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxi --lang r7rs srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71"

test-srfi-71-gerbil-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/gerbil:head bash -c "cd workdir && gxc -O srfi/71.sld"

test-srfi-71-guile:
	
	guile --fresh-auto-compile --r7rs -L . srfi-test/r7rs-programs/71.scm


test-srfi-71-guile-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/guile:latest bash -c "cd workdir && guile --fresh-auto-compile --r7rs -L . srfi-test/r7rs-programs/71.scm"


test-srfi-71-guile-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/guile:head bash -c "cd workdir && guile --fresh-auto-compile --r7rs -L . srfi-test/r7rs-programs/71.scm"
...
test-srfi-71-larceny:
	...
	larceny -r7 -I . srfi-test/r7rs-programs/71.scm


test-srfi-71-larceny-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/larceny:latest bash -c "cd workdir && larceny -r7 -I . srfi-test/r7rs-programs/71.scm"


test-srfi-71-larceny-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/larceny:head bash -c "cd workdir && larceny -r7 -I . srfi-test/r7rs-programs/71.scm"


test-srfi-71-loko:
	 ls srfi/71.sld 
	loko -std=r7rs --compile srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71

test-srfi-71-loko-build-library:
	ls srfi/71.sld

test-srfi-71-loko-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && ls srfi/71.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && loko -std=r7rs --compile srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71"

test-srfi-71-loko-build-library-docker:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:latest bash -c "cd workdir && ls srfi/71.sld"

test-srfi-71-loko-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/71.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && loko -std=r7rs --compile srfi-test/r7rs-programs/71.scm && srfi-test/r7rs-programs/71 && rm srfi-test/r7rs-programs/71"

test-srfi-71-loko-build-library-docker-head:
	docker run -it -v ${PWD}:/workdir:z schemers/loko:head bash -c "cd workdir && ls srfi/71.sld"

test-srfi-71-mit-scheme:
	
	mit-scheme --load srfi-test/r7rs-programs/71.scm


test-srfi-71-mit-scheme-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mit-scheme:latest bash -c "cd workdir && mit-scheme --load srfi-test/r7rs-programs/71.scm"


test-srfi-71-mit-scheme-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mit-scheme:head bash -c "cd workdir && mit-scheme --load srfi-test/r7rs-programs/71.scm"


test-srfi-71-mosh:
	
	mosh --loadpath=. srfi-test/r7rs-programs/71.scm


test-srfi-71-mosh-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mosh:latest bash -c "cd workdir && mosh --loadpath=. srfi-test/r7rs-programs/71.scm"


test-srfi-71-mosh-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mosh:head bash -c "cd workdir && mosh --loadpath=. srfi-test/r7rs-programs/71.scm"


test-srfi-71-racket:
	
	racket -I r7rs -S . --script srfi-test/r7rs-programs/71.scm


test-srfi-71-racket-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/racket:latest bash -c "cd workdir && racket -I r7rs -S . --script srfi-test/r7rs-programs/71.scm"


test-srfi-71-racket-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/racket:head bash -c "cd workdir && racket -I r7rs -S . --script srfi-test/r7rs-programs/71.scm"


test-srfi-71-sagittarius:
	
	sash -r7 -L . -L ./srfi srfi-test/r7rs-programs/71.scm


test-srfi-71-sagittarius-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius:latest bash -c "cd workdir && sash -r7 -L . -L ./srfi srfi-test/r7rs-programs/71.scm"


test-srfi-71-sagittarius-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius:head bash -c "cd workdir && sash -r7 -L . -L ./srfi srfi-test/r7rs-programs/71.scm"
...
test-srfi-71-tr7:
	...
	tr7i srfi-test/r7rs-programs/71.scm


test-srfi-71-tr7-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/tr7:latest bash -c "cd workdir && tr7i srfi-test/r7rs-programs/71.scm"


test-srfi-71-tr7-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/tr7:head bash -c "cd workdir && tr7i srfi-test/r7rs-programs/71.scm"


test-srfi-71-ypsilon:
	
	ypsilon --r7rs --loadpath=. srfi-test/r7rs-programs/71.scm


test-srfi-71-ypsilon-docker:
	
	docker run -it -v ${PWD}:/workdir:z schemers/ypsilon:latest bash -c "cd workdir && ypsilon --r7rs --loadpath=. srfi-test/r7rs-programs/71.scm"


test-srfi-71-ypsilon-docker-head:
	
	docker run -it -v ${PWD}:/workdir:z schemers/ypsilon:head bash -c "cd workdir && ypsilon --r7rs --loadpath=. srfi-test/r7rs-programs/71.scm"
