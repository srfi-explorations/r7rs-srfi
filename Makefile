...
test-sagittarius-srfi-64:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius bash -c "cd workdir && sash -r7 -L . srfi-test/r7rs-programs/64.scm > srfi-64.log && cat srfi-64.log"
...
test-sagittarius-srfi-8:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius bash -c "cd workdir && sash -r7 -L . srfi-test/r7rs-programs/8.scm > srfi-8.log && cat srfi-8.log"
...
test-sagittarius-srfi-1:
	...
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius bash -c "cd workdir && sash -r7 -L . srfi-test/r7rs-programs/1.scm > srfi-1.log && cat srfi-1.log"
...
test-chicken-srfi-33:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken bash -c "cd workdir &&  cp srfi/33.sld srfi-33.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-33.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/chicken bash -c "cd workdir && csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/33.scm && srfi-test/r7rs-programs/33 && rm srfi-test/r7rs-programs/33"


test-cyclone-srfi-33:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone bash -c "cd workdir && cyclone -A . srfi/33.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone bash -c "cd workdir && cyclone -A . srfi-test/r7rs-programs/33.scm && srfi-test/r7rs-programs/33 && rm srfi-test/r7rs-programs/33"


test-gambit-srfi-33:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit bash -c "cd workdir && gsc . srfi/33"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit bash -c "cd workdir && gsc -exe . -nopreload srfi-test/r7rs-programs/33.scm && srfi-test/r7rs-programs/33 && rm srfi-test/r7rs-programs/33"


test-gauche-srfi-33:
	
	docker run -it -v ${PWD}:/workdir:z schemers/gauche bash -c "cd workdir && gosh -r7 srfi-test/r7rs-programs/33.scm"


test-guile-srfi-33:
	
	docker run -it -v ${PWD}:/workdir:z schemers/guile bash -c "cd workdir && guile --fresh-auto-compile --r7rs -L . srfi-test/r7rs-programs/33.scm"


test-kawa-srfi-33:
	
	docker run -it -v ${PWD}:/workdir:z schemers/kawa bash -c "cd workdir && kawa --r7rs -Dkawa.import.path=../../*.sld srfi-test/r7rs-programs/33.scm"


test-loko-srfi-33:
	docker run -it -v ${PWD}:/workdir:z schemers/loko bash -c "cd workdir && ls srfi/33.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/loko bash -c "cd workdir && loko -std=r7rs --compile srfi-test/r7rs-programs/33.scm && srfi-test/r7rs-programs/33 && rm srfi-test/r7rs-programs/33"


test-mit-scheme-srfi-33:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mit-scheme bash -c "cd workdir && mit-scheme --load srfi-test/r7rs-programs/33.scm"


test-sagittarius-srfi-33:
	
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius bash -c "cd workdir && sash -r7 -L . srfi-test/r7rs-programs/33.scm > srfi-33.log && cat srfi-33.log"


test-stklos-srfi-33:
	
	docker run -it -v ${PWD}:/workdir:z schemers/stklos bash -c "cd workdir && stklos -I . srfi-test/r7rs-programs/33.scm"


test-skint-srfi-33:
	
	docker run -it -v ${PWD}:/workdir:z schemers/skint bash -c "cd workdir && skint --program srfi-test/r7rs-programs/33.scm"


test-tr7-srfi-33:
	
	docker run -it -v ${PWD}:/workdir:z schemers/tr7 bash -c "cd workdir && tr7i srfi-test/r7rs-programs/33.scm"


test-chibi-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/chibi bash -c "cd workdir && chibi-scheme -I ./srfi srfi-test/r7rs-programs/14.scm"


test-chicken-srfi-14:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken bash -c "cd workdir &&  cp srfi/14.sld srfi-14.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-14.sld"
...
test-cyclone-srfi-14:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone bash -c "cd workdir && cyclone -A . srfi/14.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone bash -c "cd workdir && cyclone -A . srfi-test/r7rs-programs/14.scm && srfi-test/r7rs-programs/14 && rm srfi-test/r7rs-programs/14"


test-gambit-srfi-14:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit bash -c "cd workdir && gsc . srfi/14"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit bash -c "cd workdir && gsc -exe . -nopreload srfi-test/r7rs-programs/14.scm && srfi-test/r7rs-programs/14 && rm srfi-test/r7rs-programs/14"


test-gauche-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/gauche bash -c "cd workdir && gosh -r7 srfi-test/r7rs-programs/14.scm"


test-guile-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/guile bash -c "cd workdir && guile --fresh-auto-compile --r7rs -L . srfi-test/r7rs-programs/14.scm"


test-kawa-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/kawa bash -c "cd workdir && kawa --r7rs -Dkawa.import.path=../../*.sld srfi-test/r7rs-programs/14.scm"


test-loko-srfi-14:
	docker run -it -v ${PWD}:/workdir:z schemers/loko bash -c "cd workdir && ls srfi/14.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/loko bash -c "cd workdir && loko -std=r7rs --compile srfi-test/r7rs-programs/14.scm && srfi-test/r7rs-programs/14 && rm srfi-test/r7rs-programs/14"


test-mit-scheme-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mit-scheme bash -c "cd workdir && mit-scheme --load srfi-test/r7rs-programs/14.scm"


test-sagittarius-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius bash -c "cd workdir && sash -r7 -L . srfi-test/r7rs-programs/14.scm > srfi-14.log && cat srfi-14.log"


test-stklos-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/stklos bash -c "cd workdir && stklos -I . srfi-test/r7rs-programs/14.scm"


test-skint-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/skint bash -c "cd workdir && skint --program srfi-test/r7rs-programs/14.scm"


test-tr7-srfi-14:
	
	docker run -it -v ${PWD}:/workdir:z schemers/tr7 bash -c "cd workdir && tr7i srfi-test/r7rs-programs/14.scm"


test-chibi-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/chibi bash -c "cd workdir && chibi-scheme -I ./srfi srfi-test/r7rs-programs/13.scm"


test-chicken-srfi-13:
	docker run -it -v ${PWD}:/workdir:z schemers/chicken bash -c "cd workdir &&  cp srfi/13.sld srfi-13.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-13.sld"
...
test-cyclone-srfi-13:
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone bash -c "cd workdir && cyclone -A . srfi/13.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/cyclone bash -c "cd workdir && cyclone -A . srfi-test/r7rs-programs/13.scm && srfi-test/r7rs-programs/13 && rm srfi-test/r7rs-programs/13"


test-gambit-srfi-13:
	docker run -it -v ${PWD}:/workdir:z schemers/gambit bash -c "cd workdir && gsc . srfi/13"
	docker run -it -v ${PWD}:/workdir:z schemers/gambit bash -c "cd workdir && gsc -exe . -nopreload srfi-test/r7rs-programs/13.scm && srfi-test/r7rs-programs/13 && rm srfi-test/r7rs-programs/13"


test-gauche-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/gauche bash -c "cd workdir && gosh -r7 srfi-test/r7rs-programs/13.scm"


test-guile-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/guile bash -c "cd workdir && guile --fresh-auto-compile --r7rs -L . srfi-test/r7rs-programs/13.scm"


test-kawa-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/kawa bash -c "cd workdir && kawa --r7rs -Dkawa.import.path=../../*.sld srfi-test/r7rs-programs/13.scm"


test-loko-srfi-13:
	docker run -it -v ${PWD}:/workdir:z schemers/loko bash -c "cd workdir && ls srfi/13.sld"
	docker run -it -v ${PWD}:/workdir:z schemers/loko bash -c "cd workdir && loko -std=r7rs --compile srfi-test/r7rs-programs/13.scm && srfi-test/r7rs-programs/13 && rm srfi-test/r7rs-programs/13"


test-mit-scheme-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/mit-scheme bash -c "cd workdir && mit-scheme --load srfi-test/r7rs-programs/13.scm"


test-sagittarius-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/sagittarius bash -c "cd workdir && sash -r7 -L . srfi-test/r7rs-programs/13.scm > srfi-13.log && cat srfi-13.log"


test-stklos-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/stklos bash -c "cd workdir && stklos -I . srfi-test/r7rs-programs/13.scm"


test-skint-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/skint bash -c "cd workdir && skint --program srfi-test/r7rs-programs/13.scm"


test-tr7-srfi-13:
	
	docker run -it -v ${PWD}:/workdir:z schemers/tr7 bash -c "cd workdir && tr7i srfi-test/r7rs-programs/13.scm"
