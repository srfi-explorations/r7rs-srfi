        ...
        stage("foment") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "foment" "foment -I --load" "" 8 1 14 26 28 33 13 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("mit-scheme") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "mit-scheme" "mit-scheme --load" "" 8 1 14 26 28 33 13 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("ypsilon") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "ypsilon" "ypsilon --warning --verbose --clean-acc --acc=/tmp --r7rs --loadpath=." "" 8 1 14 26 28 33 13 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
