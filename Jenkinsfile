        ...
        stage("chicken") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh 'csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/64.scm && srfi-test/r7rs-programs/64 > srfi-64.log && rm srfi-test/r7rs-programs/64'
                    sh ' cp srfi/8.sld srfi-8.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-8.sld'
                    sh 'csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/8.scm && srfi-test/r7rs-programs/8 > srfi-8.log && rm srfi-test/r7rs-programs/8'
                    sh ' cp srfi/1.sld srfi-1.sld && csc -include-path ./srfi -X r7rs -R r7rs -s -J srfi-1.sld'
                    sh 'csc -include-path ./srfi -X r7rs -R r7rs srfi-test/r7rs-programs/1.scm && srfi-test/r7rs-programs/1 > srfi-1.log && rm srfi-test/r7rs-programs/1'
        ...
        stage("cyclone") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh 'cyclone -A . srfi-test/r7rs-programs/64.scm && srfi-test/r7rs-programs/64 > srfi-64.log && rm srfi-test/r7rs-programs/64'
                    sh 'cyclone -A . srfi/8.sld'
                    sh 'cyclone -A . srfi-test/r7rs-programs/8.scm && srfi-test/r7rs-programs/8 > srfi-8.log && rm srfi-test/r7rs-programs/8'
                    sh 'cyclone -A . srfi/1.sld'
                    sh 'cyclone -A . srfi-test/r7rs-programs/1.scm && srfi-test/r7rs-programs/1 > srfi-1.log && rm srfi-test/r7rs-programs/1'
        ...
        stage("gambit") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    unstash 'tests'
                    sh 'gsc . srfi/64'
                    sh 'gsc -:r7rs -exe . -nopreload srfi-test/r7rs-programs/64.scm && srfi-test/r7rs-programs/64 > srfi-64.log && rm srfi-test/r7rs-programs/64'
                    sh 'gsc . srfi/8'
                    sh 'gsc -:r7rs -exe . -nopreload srfi-test/r7rs-programs/8.scm && srfi-test/r7rs-programs/8 > srfi-8.log && rm srfi-test/r7rs-programs/8'
                    sh 'gsc . srfi/1'
                    sh 'gsc -:r7rs -exe . -nopreload srfi-test/r7rs-programs/1.scm && srfi-test/r7rs-programs/1 > srfi-1.log && rm srfi-test/r7rs-programs/1'
        ...
        stage("loko") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    unstash 'tests'
                    sh 'ls srfi/64.sld'
                    sh 'loko -std=r7rs --compile srfi-test/r7rs-programs/64.scm && srfi-test/r7rs-programs/64 > srfi-64.log && rm srfi-test/r7rs-programs/64'
                    sh 'ls srfi/8.sld'
                    sh 'loko -std=r7rs --compile srfi-test/r7rs-programs/8.scm && srfi-test/r7rs-programs/8 > srfi-8.log && rm srfi-test/r7rs-programs/8'
                    sh 'ls srfi/1.sld'
                    sh 'loko -std=r7rs --compile srfi-test/r7rs-programs/1.scm && srfi-test/r7rs-programs/1 > srfi-1.log && rm srfi-test/r7rs-programs/1'
