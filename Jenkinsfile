pipeline {
    ...
    parameters {
        ...
        string(name: 'SRFIS', defaultValue: '1 2 4 5 8 11 13 14 16 19 27 28 31 37 38 39 41 42 43 44 48 51 54 60 63 64 69 87 95 11 113 115 116 128 145 180', description: 'Test SRFIs')
    }
