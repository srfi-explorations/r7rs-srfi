        ...
        stage("chibi") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "chibi" "chibi-scheme -I ." "" 8 1 14 26 28 64 151 '
        ...
        stage("chicken") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "chicken" "csc -include-path ./srfi -X r7rs -R r7rs" "csc -include-path ./srfi -X r7rs -R r7rs -s -J" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("foment") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "foment" "foment -I . -I ./srfi" "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("gambit") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "gambit" "gsc -exe ./ -nopreload" "gsc -:search=." 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("gauche") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "gauche" "gosh -r7 -I ." "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("guile") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "guile" "guile --fresh-auto-compile --r7rs -L ." "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("kawa") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "kawa" "kawa --r7rs -Dkawa.import.path=../.." "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("mit-scheme") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "mit-scheme" "mit-scheme --batch-mode --load ./srfi/26.sld ./srfi/28.sld ./srfi/64.sld" "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("mosh") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "mosh" "mosh --loadpath=." "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("racket") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "racket" "racket -I r7rs -S . --script" "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("sagittarius") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "sagittarius" "sash -r7 -L . -L ./srfi" "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("stklos") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "stklos" "stklos -I . -I ./srfi -f" "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("skint") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "skint" "skint -I ./" "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("tr7") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "tr7" "tr7i" "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
        ...
        stage("ypsilon") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh './jenkins_scripts/clean.sh'
                    unstash 'tests'
                    sh './jenkins_scripts/test.sh "ypsilon" "ypsilon --r7rs --loadpath=. --loadpath=./srfi" "" 8 1 14 26 28 64 151 '
                    archiveArtifacts artifacts: 'reports/*.log'
                    sh 'rm -rf *.log'
                }
            }
