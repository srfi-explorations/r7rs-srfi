        ...
        stage("SRFI-8 - loko") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh 'loko -std=r7rs -feval --compile srfi/64.sld  && loko -std=r7rs -feval --compile srfi/8.sld'
                    sh 'loko -std=r7rs -feval --compile srfi-test/r7rs-programs/8.scm && srfi-test/r7rs-programs/8 && rm srfi-test/r7rs-programs/8'
        ...
        stage("SRFI-64 - loko") {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh 'loko -std=r7rs -feval --compile srfi/64.sld  && loko -std=r7rs -feval --compile srfi/64.sld'
                    sh 'loko -std=r7rs -feval --compile srfi-test/r7rs-programs/64.scm && srfi-test/r7rs-programs/64 && rm srfi-test/r7rs-programs/64'
