pipeline {
    ...
    parameters {
        ...
        string(name: 'R7RS_SCHEMES', defaultValue: 'capyscheme chibi foment gauche gambit kawa meevax mit-scheme mosh racket sagittarius skint stklos tr7 ypsilon', description: 'Test SRFIs')
